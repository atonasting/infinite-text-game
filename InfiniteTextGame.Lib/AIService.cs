...
namespace InfiniteTextGame.Lib
{
    ...
    public class AIService
    {
        ...
        private readonly int _titleMaxLength = 4;//默认标题最大单词数（暂定）
        private readonly int _optionNameMaxLength = 4;//默认选项名最大单词数（暂定）
        private readonly int _optionDescriptionMaxLength = 8;//默认选项描述最大单词数（暂定）
